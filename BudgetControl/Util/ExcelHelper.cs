...
namespace BudgetControl.Util
{
    public class ExcelHelper
    {
        ...
        public static void ToExcelWithResponse(DataSet dsInput, string filename, HttpResponse response)
        {
        ...
        public static string ToExcel(DataSet dsInput)
        {
            var excelXml = GetExcelXml(dsInput, "text.xls");
            return excelXml;
        }
